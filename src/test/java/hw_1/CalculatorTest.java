...
class CalculatorTest {
    ...
    void testCalculateDiscount(){
        double result = calculator.calculateDiscount(100.5,50);
        assertEquals(50.25, result, "the amount of 100.5 after deducting 50% should be 50.25");
    }

    @Test
    @DisplayName("Test wrong percentages for calculate discount")
    void testWrongPercentages(){
        assertThrows(ArithmeticException.class, () -> calculator.calculateDiscount(100, 150),
    ...
    void testNegativeAmount(){
        assertThrows(ArithmeticException.class, () -> calculator.calculateDiscount(-100, 50),
